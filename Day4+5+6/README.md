...
### SetUp
 1. Installed ethers library to connect my js code to blockchain and installed browserify to allow ethers imported functions to work on browser.

 2. Solidity contract contains Deposit function which allows user to deposit certain Eth and it has mapping that is address=> amount.

 3. Deployed Ledger.sol through foundry using broadcast script and connected in to frontend using ethers imported function.
